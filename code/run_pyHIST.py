import os
WSI_type=".ndpi"
saved_path = 'path/to/your/output/directory/'
...
for i in slide_list:
    os.system(f'python {pyhist_path}pyhist.py --content-threshold 0.05 --output {saved_path} --output-downsample 1 --save-patches --save-tilecrossed-image --info "verbose" {i}')